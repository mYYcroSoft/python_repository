...
class Snowfall:
    ...
    def __init__(self, **kwargs):
      ...
      #  self.__info = pygame.display.Info()
        self.__width = kwargs.get('width', 800)
        self.__height = kwargs.get('height', 600)
        self.__snowflakes_amount = kwargs.get('snowflakes_amount', self.__width * self.__height // 2000)
        self.__snowflakes_to_add = kwargs.get('snowflakes_to_add', self.__width // 20)
        ...
        self.__bg = pygame.image.load("back.jpg")
